...
# Railway uses its own healthcheck via railway.toml (healthcheckPath)
# No Docker HEALTHCHECK needed — Caddy admin API is disabled in prod
CMD [ "frankenphp", "run", "--config", "/etc/frankenphp/Caddyfile" ]
